...
public partial class WorkersViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private DateTimeOffset? _birthDate = DatePickerValue.FromDateOnly(new DateOnly(1990, 1, 1));
    ...
    private async Task LoadSelectedAsync()
    {
        ...
        BirthDate = DatePickerValue.FromDateOnly(detail.BirthDate);
    ...
    private void StartNew()
    {
        ...
        LastName = "";
        FirstMiddleName = "";
        BirthDate = DatePickerValue.FromDateOnly(new DateOnly(1990, 1, 1));
        HomeAddress = "";
        Education = "";
        Qualification = "";
        foreach (var op in Operations)
    ...
    public async Task SaveAsync()
    {
        ...
        var body = new WorkerCreateUpdateRequest
        {
            ...
            BirthDate = DatePickerValue.ToDateOnly(BirthDate) ?? DateOnly.FromDateTime(DateTime.Today),
