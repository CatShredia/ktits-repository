...
namespace CinemaAPI.Migrations
{
    ...
    [Migration("20260401062022_AddChatRelation")]
    partial class AddChatRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaAPI.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CinemaAPI.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CinemaAPI.Models.Chat", b =>
                {
                    b.HasOne("CinemaAPI.Models.User", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CinemaAPI.Models.User", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaAPI.Models.ChatMessage", b =>
                {
                    b.HasOne("CinemaAPI.Models.Chat", "Chat")
                        .WithMany("Messages")
